...
class owner:
    ...
    """
    user_log = []  # Empty owner log

    def __init__(self, user_name, user_password):
        '''
        __init__ method that helps us define properties for our objects.
        Args:
            user_name: New owner name.
        '''
    ...
    def save_user(self):
        '''
        save_user method saves owner objects into user_log
        '''

        owner.user_log.append(self)


class Credentials:
    """
    Class that generates new instances of owner Credentials
    """
